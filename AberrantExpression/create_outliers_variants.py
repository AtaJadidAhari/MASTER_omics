...
outlier_res = "/omics/odcf/analysis/hipo/hipo_021/outlier_analysis/py_outrider_runs/zscores/aggregated_sf_zScores_all.tsv"
...
py_or_res_all.to_csv(f"{"/".join(outlier_res.split("/")[:-1])}/or_variants.csv", index=None)
