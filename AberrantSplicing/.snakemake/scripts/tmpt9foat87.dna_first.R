...
snakemake <- Snakemake(
    ...
    output = list('/omics/odcf/analysis/hipo/hipo_021/outlier_analysis/drop_runs/drop_master_202502_allGenes/processed_results/aberrant_splicing/results/v19/fraser/Bone/results_gene_all.tsv'),
    params = list('Bone', "cohort" = 'Bone'),
    wildcards = list('Bone', "cohort" = 'Bone'),
    threads = 1,
    log = list(),
    resources = list('mem_mb', 'mem_mib', 'disk_mb', 'disk_mib', 'tmpdir', "mem_mb" = 90000, "mem_mib" = 85831, "disk_mb" = 1000, "disk_mib" = 954, "tmpdir" = '/local/a379i/47118902/cluster_tmp'),
    config = list(),
